...
def crear_frame_medidas_monitora(parent):
    ...
    # Ruta del archivo medidas_monitora.json
    json_path_monitora = os.path.join("AAA_ST_REGISTROS", "medidas_monitora.json")

    # Función para guardar datos en la tabla resumen y archivo JSON
    def guardar_datos_en_tabla_monitora():
        global fila_actual2
        ...
        try:
            ...
            medida_key = f"m{fila_actual2 + 1}_monitora"
            data = {
                medida_key: {
                    "escala": escala,
            ...
            if os.path.exists(json_path_monitora):
                try:
                    with open(json_path_monitora, "r") as file:
            ...
            with open(json_path_monitora, "w") as file:
    ...
    guardar_btn = tk.Button(
        ...
        command=guardar_datos_en_tabla_monitora,
        bg="light green",
        fg="black",
        font=("Arial", 10),
        width=18
    ...
    siguiente_btn = tk.Button(
        ...
        command=siguiente_medida_monitora,
        bg="#FFE5CC",
        fg="black",
        font=("Arial", 10),
        width=18
